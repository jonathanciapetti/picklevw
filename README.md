...
**picklevw** (pronunced *pickleview*) is a small multithreaded desktop application built with Python, designed to read and display pickle files using Pandas and Tkinter.
